...
public enum ProcessTaskStepNotifyTriggerType implements INotifyTriggerType {
    ...
    PAUSE("pause", "enum.process.processtaskstepnotifytriggertype.pause", "enum.process.processtaskstepnotifytriggertype.pause.1"),
    RECOVER("recover", "enum.process.processtaskstepnotifytriggertype.recover", "enum.process.processtaskstepnotifytriggertype.recover.1"),

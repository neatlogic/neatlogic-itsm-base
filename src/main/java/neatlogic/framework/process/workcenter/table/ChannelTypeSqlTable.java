...
public class ChannelTypeSqlTable implements ISqlTable {
    ...
    public enum FieldEnum {
        UUID("uuid", new I18n("nfpwt.channeltypesqltable.text.uuid"),"channelTypeUuid"),
        NAME("name",new I18n("nfpwt.channeltypesqltable.text.name"),"channelTypeName"),
        COLOR("color",new I18n("nfpwt.channeltypesqltable.text.color"),"channelTypeColor")
        ;

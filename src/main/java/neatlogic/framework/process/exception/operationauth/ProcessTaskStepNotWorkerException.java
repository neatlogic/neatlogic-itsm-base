 ...
 **/
public class ProcessTaskStepNotWorkerException extends ProcessTaskPermissionDeniedException {
    private static final long serialVersionUID = 9216337410118158654L;

    public ProcessTaskStepNotWorkerException() {
        super("nfpeo.processtaskstepnotworkerexception.processtaskstepnotworkerexception");
    }
}

 ...
 **/
public class ProcessTaskAbortedException extends ProcessTaskPermissionDeniedException {
    private static final long serialVersionUID = 9216337410118158634L;

    public ProcessTaskAbortedException() {
        super("nfpeo.processtaskabortedexception.processtaskabortedexception");
    }
}

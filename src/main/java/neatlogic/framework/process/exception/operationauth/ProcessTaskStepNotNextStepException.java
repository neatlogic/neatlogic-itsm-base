 ...
 **/
public class ProcessTaskStepNotNextStepException extends ProcessTaskPermissionDeniedException {
    private static final long serialVersionUID = 9216337410118158656L;

    public ProcessTaskStepNotNextStepException() {
        super("nfpeo.processtaskstepnotnextstepexception.processtaskstepnotnextstepexception");
    }
}

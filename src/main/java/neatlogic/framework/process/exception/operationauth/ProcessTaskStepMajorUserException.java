 ...
 **/
public class ProcessTaskStepMajorUserException extends ProcessTaskPermissionDeniedException {
    private static final long serialVersionUID = 9216337410118158658L;

    public ProcessTaskStepMajorUserException() {
        super("nfpeo.processtaskstepmajoruserexception.processtaskstepmajoruserexception");
    }
}

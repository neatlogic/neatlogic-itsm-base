...
public class ProcessTaskSerialNumberSeedResetJob extends JobBase {
    ...
    public void initJob(String tenantUuid) {
        List<ProcessTaskSerialNumberPolicyVo> processTaskSerialNumberPolicyList =
            channelMapper.getAllProcessTaskSerialNumberPolicyList();
            ...
            if (handler != null) {
                ...
                if (StringUtils.isNotBlank(cron) && CronExpression.isValidExpression(cron)) {
                    JobObject.Builder jobObjectBuilder =
                        new JobObject.Builder(processTaskSerialNumberPolicyVo.getChannelTypeUuid(), this.getGroupName(),
                            this.getClassName(), TenantContext.get().getTenantUuid()).addData("channelTypeUuid",
